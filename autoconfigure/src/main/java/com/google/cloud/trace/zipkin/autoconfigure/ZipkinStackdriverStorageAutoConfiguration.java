...
public class ZipkinStackdriverStorageAutoConfiguration {
	...
	@Bean
	StorageComponent storage(@Qualifier("stackdriverExecutor") ThreadPoolTaskExecutor executor, TraceConsumer consumer, ZipkinStackdriverStorageProperties properties) {
		return new StackdriverStorageComponent(properties.getProjectId(), consumer, executor);
	}
}
